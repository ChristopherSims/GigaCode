...
from gigacode.intent_cache import IntentCache  # noqa: E402
...
class SemanticQueryCache:
            ...
            try:
                ...
                for cache_key, entry in list(self._cache.items()):
                    ...
                    if similarity >= self._similarity_threshold:
                        ...
                        self._hits += 1
                        logger.debug(f"Cache HIT (semantic, {similarity:.3f}): {query[:50]}")
    ...
    def put(
        ...
        if len(self._cache) > self._max_entries:
            ...
            logger.debug("Cache evicted (LRU): oldest entry removed")
