...
class StateManager:
    ...
    def _recover_from_wal(self) -> None:
        ...
        for tx in pending:
            ...
            self._write_wal_entry(
                tx.transaction_id, tx.operation, tx.buffer_id,
                tx.file_path, tx.start_line, tx.end_line, tx.new_lines,
                status="rolled_back"
            )
    ...
    def start_transaction(
        ...
        self._write_wal_entry(
            transaction_id, operation, buffer_id, file_path,
            start_line, end_line, new_lines, status="pending"
        )
