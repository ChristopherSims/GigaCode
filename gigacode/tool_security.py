...
from gigacode.exceptions import RateLimitExceeded, QueryLimitExceeded, InvalidPathError
...
class ToolSecurityLayer:
    ...
    def check_rate_limit(self, operation: str, buffer_id: Optional[str] = None) -> Tuple[bool, Optional[str]]:
