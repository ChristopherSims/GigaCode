...
class IncrementalIndexManager:
    ...
    def compute_incremental_update(
        ...
        # Detect changes
        changed_chunks, removed_chunk_ids, kept_chunk_ids = self._chunk_tracker.detect_changes(
            file_path, new_chunks
        )
        ...
        # Update cache
        for chunk, embedding in zip(changed_chunks, changed_embeddings, strict=False):
            chunk_id = f"{file_path}#{chunk.start_line}#{chunk.end_line}"
