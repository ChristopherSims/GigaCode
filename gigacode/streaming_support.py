...
class ChunkBoundaryPreserver:
    ...
    def find_safe_break_point(self, content: str, target_position: int) -> int:
...
class StreamingChunker:
    ...
    def __init__(self, max_chunk_bytes: int = 1024 * 1024, language: str = "python"):
    ...
    def stream_chunks(self, file_path: str, chunk_handler) -> None:
