...
class TestSnapshotManager:
    ...
    def test_snapshot_persistence(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            manifest1 = manager1.create_snapshot(
                "buf-1", root, {"module.py": root / "module.py"}
            )
    ...
    def test_write_file_with_merge(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Write new content
            result = manager.write_file_with_merge(
                "module.py",
                ["modified", "code"]
            )
    ...
    def test_metadata_size_vs_full_snapshot(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            manifest = manager.create_snapshot(
                "buf-1", root, {"large.py": root / "large.py"}
            )
            ...
            logger.info(f"Source: {len(large_content)} bytes, "
