...
from gigacode.faiss_optimizer import FAISSIndexOptimizer, IndexType
...
def test_index_parameters():
    ...
    try:
        ...
        print(f"✅ HNSW parameters: nlinks={params['nlinks']}, efConstruction={params['efConstruction']}")
...
def test_index_creation_performance():
    ...
    try:
        ...
        for vector_count, expected_type in test_cases:
            ...
            assert selected_type == expected_type, f"Type mismatch: {selected_type} vs {expected_type}"
            ...
            print(f"✅ {selected_type:6s} ({vector_count:6d} vectors): "
...
def test_distance_metrics():
    ...
    try:
        ...
        print(f"✅ Results sorted by distance")
