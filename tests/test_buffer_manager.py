...
class TestAuditLogging:
    ...
    def test_audit_log_creates_entries(self, buffer_manager):
        ...
        buffer_manager._audit_log(
            operation="test_op", buffer_id="test_id", status="ok", details={"key": "value"}
        )
...
class TestRegistryManagement:
    ...
    def test_get_buffer_info_returns_info(self, buffer_manager):
        ...
        buffer_manager._registry["test_id"] = {"root": "/test/path", "buffer_dir": "/test/buffer"}
    ...
    def test_save_registry_persists_to_disk(self, buffer_manager):
        ...
        buffer_manager._registry["test_id"] = {"root": "/test/path"}
...
class TestBufferLifecycle:
    ...
    def test_delete_buffer_removes_from_registry(self, buffer_manager):
        ...
        buffer_manager._registry["buf1"] = {"root": "/path1", "buffer_dir": "/tmp/nonexistent"}
        buffer_manager._save_registry()
    ...
    def test_delete_buffer_logs_audit(self, buffer_manager):
        ...
        buffer_manager._registry["buf1"] = {"root": "/path", "buffer_dir": "/tmp/nonexistent"}
...
class TestReadCode:
    ...
    def test_read_code_missing_snapshot(self, buffer_manager):
        ...
        buffer_manager._registry["test_buf"] = {"root": "/test", "buffer_dir": "/nonexistent"}
...
class TestWriteCode:
    ...
    def test_write_code_unknown_buffer(self, buffer_manager):
        ...
        result = buffer_manager.write_code("nonexistent", "file.py", 1, ["new_line"])
    ...
    def test_write_code_missing_snapshot(self, buffer_manager):
        ...
        result = buffer_manager.write_code("test_buf", "file.py", 1, ["new_line"])
