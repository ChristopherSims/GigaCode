...
from gigacode.semantic_cache import SemanticQueryCache, SearchResultCache
...
def test_chunk_diff_tracker():
    ...
    try:
        ...
        print(f"✅ Correctly detected 1 changed chunk")
        ...
        print(f"✅ Correctly detected 1 removed chunk")
        ...
        print(f"✅ Correctly detected 1 added chunk")
...
def test_incremental_index_manager():
    ...
    try:
        ...
        print(f"✅ Registered initial index with 2 chunks")
        
        # Verify cache
        stats = manager.get_cache_stats()
        assert stats["cached_embeddings"] == 2
        print(f"✅ Cache has 2 embeddings")
...
def test_semantic_cache():
    ...
    try:
        ...
        assert cached[1] == True  # Exact match
        print(f"✅ Retrieved exact match from cache")
...
def test_performance_comparison():
    ...
    try:
        ...
        chunks = [
            MockChunk(f"def func_{i}(): pass", "test.py", i*2, i*2+1)
            for i in range(100)
        ]
        ...
        print(f"✅ Efficiency: Only embedded {metadata['changed_count']}/{metadata['total_chunks']} chunks")
