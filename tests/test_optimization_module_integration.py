...
def test_incremental_indexer_integration():
    ...
    try:
        ...
        print(f"✅ IndexManager has _incremental_manager: {type(manager._incremental_manager).__name__}")
        
        # Verify incremental manager has chunk tracker
        assert hasattr(manager._incremental_manager, '_chunk_tracker')
        print(f"✅ IncrementalIndexManager has _chunk_tracker")
...
def test_semantic_cache_integration():
    ...
    try:
        ...
        print(f"✅ SearchService has _semantic_query_cache: {type(search_service._semantic_query_cache).__name__}")
        ...
        print(f"✅ SemanticQueryCache has expected methods (get, put, get_stats)")
...
def test_gpu_index_faiss_integration():
    ...
    try:
        ...
        print(f"✅ GPUIndex supports index_type parameter")
...
def test_end_to_end_integration():
    ...
    try:
        ...
        assert search_service._semantic_query_cache is not None
        print(f"✅ All Phase 3b components initialized")
...
def test_incremental_tracking_flow():
    ...
    try:
        ...
        print(f"✅ Incremental manager accessible from IndexManager")
        
        # Verify chunk tracker
        tracker = inc_manager._chunk_tracker
        assert tracker is not None
        print(f"✅ Chunk tracker accessible")
        ...
        print(f"✅ Registered 2 chunks in tracker")
        ...
        assert len(kept) == 2
        print(f"✅ Change detection working: 0 changed, 0 removed, 2 kept")
...
def test_semantic_cache_flow():
    ...
    try:
        ...
        print(f"✅ Retrieved result from cache (exact match)")
